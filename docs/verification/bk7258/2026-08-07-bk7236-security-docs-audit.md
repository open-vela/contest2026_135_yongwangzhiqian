...
- 当前项目官方启动链证据矩阵：`docs/verification/bk7258/2026-08-07-bk7258-boot-chain-evidence-matrix.md`
- 当前项目同架构 MCUboot 参考：`docs/verification/bk7258/2026-08-07-beken-mcuboot-reference-flow.md`
